...
export default function CameraCapture({ isVideoStopped = false }: CameraCaptureProps) {
  ...
  return (
    <div className="flex flex-col gap-2 h-full w-full overflow-hidden">
      {/* Main content area with webcam - limit max height on mobile */}
      <div className="relative flex-1 flex flex-col items-center overflow-hidden rounded-3xl max-h-[70vh] md:max-h-none">
      ...
      <div className="flex-shrink-0 min-h-[60px]">
        <StatusDisplay
          error={error}
